...
.pull-right[
This example is from [CUNY School of Professional Studies](https://sps.cuny.edu/) bridge tutorials for the [Master in Data Science](http://catalog.sps.cuny.edu/preview_program.php?catoid=2&poid=607) degree program.
...
[`r icons::fontawesome("link") |> icons::icon_style(fill = 'white')` github.com/jbryer/login](https://jbryer.github.io/login/)   

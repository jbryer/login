...
* Slides from ShinyConf 2024 [HTML](http://htmlpreview.github.io/?https://github.com/jbryer/login/blob/main/inst/slides/login.html) or [PDF](https://github.com/jbryer/login/tree/main/inst/slides/login.pdf)

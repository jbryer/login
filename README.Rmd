...
Please see the vignette `vignette('login', package = 'login')` or [website](https://jbryer.github.io/login/articles/login.html) for more details on how to use this package with your Shiny application.
